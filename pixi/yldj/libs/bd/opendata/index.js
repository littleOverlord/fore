let sharedCanvas = swan.getSharedCanvas();
let context = sharedCanvas.getContext('2d');
let screen;

const screenWidth = swan.getSystemInfoSync().screenWidth;
const screenHeight = swan.getSystemInfoSync().screenHeight;
const ratio = swan.getSystemInfoSync().pixelRatio;
let itemCanvas = swan.createCanvas();
