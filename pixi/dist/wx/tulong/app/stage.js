...
export default class Stage {
  ...
  static init() {
    ...
    textMgr = new TextAnimate(textAni, {
      fontFamily: 'Arial',
      fontSize: 24,
      fill: 0xff0000
    });
  ...
  static removeFighter(id) {
    ...
    if (f.sid !== roleId) {
      Stage.addDelay(Stage.addMonster, 2000);
    }
  }
...
let fightScene; //fighter显示列表

const fighterMap = {}; //玩家id

const roleId = "role"; //玩家自己

let roleSelf; //怪物位置

const monsterX = 800; //战斗飘字管理
